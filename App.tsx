...
import { fetchCategories, fetchPosters, getUserCredits, updateUserCredits, fetchUserHistory, saveUserHistory, HistoryItem } from './services/dataService';
    ...
    try {
      const options = {
        ...
        handler: async function (response: any) {
          ...
          if (userId) {
            // Add purchased credits, then deduct 1 for current generation
